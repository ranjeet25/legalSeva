    ...
    <div className="mx-auto max-w-screen-2xl px-4 md:px-8">
      <header className="mb-8 flex items-center justify-between py-4 md:mb-12 md:py-8 xl:mb-16">
        ...
        >
          <svg
            ...
            height={94}
            viewBox="0 0 95 94"
            className="h-auto w-6 text-yellow-500"
            fill="currentColor"
        ...
        <nav className="hidden gap-12 lg:flex">
          <a href="#" className="text-lg font-semibold text-yellow-500">
            Home
          </a>
          <a
            href="#"
            className="text-lg font-semibold text-gray-600 transition duration-100 hover:text-yellow-500 active:text-yellow-700"
          >
            Features
          </a>
          <a
      ...
      <section className="mb-8 flex flex-col justify-between gap-6 sm:gap-10 md:mb-16 md:gap-16 lg:flex-row">
        ...
        <div className="flex flex-col justify-center sm:text-center lg:py-12 lg:text-left xl:w-5/12">
          <p className="mb-4 font-semibold text-yellow-500 md:mb-6 md:text-lg xl:text-xl">
            Very proud to introduce
          </p>
          <p className="mb-8 text-2xl text-black sm:text-5xl md:mb-12 md:text-6xl">
            Revolutionary way to Deal with  <p className=' font-bold '>legal Terms</p>
          </p>
